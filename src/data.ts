...
export const testimonials: Testimonial[] = [
  ...
  id: 1,
  rating: '5.0',
  quote: 'Musa and his team delivered the website project on time and followed through on the agreed requirements. He communicated well throughout the process and contributed to a smooth, successful delivery.',
...
},
{
  id: 2,
  rating: '5.0',
  quote: 'Musa showed strong research and implementation skills while improving performance across multiple ecommerce sites. His work helped make the sites faster, cleaner, and more reliable for users.',
...
},
{
  id: 3,
  rating: '5.0',
  quote: 'Musa was dependable, easy to work with, and delivered quality website development work. He was responsive to feedback and helped move the project forward efficiently.',
  author: 'Kyle Lacroix',
  role: 'CEO',
  organization: 'Self Justice',
  project: 'Website Development',
